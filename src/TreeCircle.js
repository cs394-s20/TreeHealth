...
const TreeCircle = ({ treeData, navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <View>
        <React.Fragment>
          <Image  style={{ width: 150, height: 150, borderRadius: 75}} source={require("./testtree.png")} /> 
          ...
          <View>
            <IconBadge 
              BadgeElement={
                ...
                treeData.health === 0 ? <Image  style={{ width: 40, height: 40 }} source={require('./healthy_tree.png')} /> :
                (treeData.health === 1 ?  <Image  style={{ width: 40, height: 40 }} source={require('./declining_tree.png')} /> :
                                          <Image  style={{ width: 40, height: 40 }} source={require('./dead_tree.png')} /> )
              }
              IconBadgeStyle={
                {width:60,
                height:60,
